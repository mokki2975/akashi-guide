  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        // アプリ全体のデフォルトフォントを Noto Sans JP に設定
    ...
    return Scaffold(
      ...
      body: Center(
        child: ConstrainedBox(
          constraints: const BoxConstraints(maxWidth: 800), // Web閲覧用に幅を制限
          child: Padding(
                ...
                Expanded(
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return MenuTile(item: guideItems[index]);
                    },
                  ),
                ),
              ],
